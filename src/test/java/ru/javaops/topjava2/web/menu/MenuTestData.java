...
public class MenuTestData {
    ...
    public static final MenuItem BIG_MAC = new MenuItem(1, "Big Mac", MCDONALDS, DateTimeUtil.getCurrentDate(), 200);
    public static final MenuItem SAUSAGE_BURRITO = new MenuItem(null, "Big Mac", MCDONALDS, DateTimeUtil.getCurrentDate(), 200);
